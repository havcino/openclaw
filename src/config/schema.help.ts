...
export const FIELD_HELP: Record<string, string> = {
  ...
  "plugins.entries.*.hooks.allowConversationAccess":
    "Controls whether this plugin may read raw conversation content from typed hooks such as `before_agent_run`, `llm_input`, `llm_output`, `before_agent_finalize`, and `agent_end`. Non-bundled plugins must opt in explicitly.",
